...
class CrmLead(models.Model):
    ...
    sanitary_installation_type = fields.Selection([('general', 'General'), ('detailed', 'Detailed')], default='general', string=" ")
